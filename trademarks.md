...
One of these requirements is for the trademark owner (in this case, UCAR)
...
or anyone else who might be likely to use netCDF services, software, or applications.
...
UCAR may require you to cease all use of any netCDF trademark,
...
Although many uses of netCDF's trademarks are governed by more specific rules,
...
- Use of the word "netCDF" in email and informally -- Allowed without the TM symbol.
